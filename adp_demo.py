...
async def run_console_demo():
    ...
    # Updated demo queries to match available domains
    demo_queries = [
        ...
        ("What are early signs of brain tumors?", "neurology", "high"),
        ("Evaluate AI model bias in hiring decisions", "ai_compliance", "urgent"),
        ("General medical triage for flu symptoms", "medical", "normal"),
        ("Cancer treatment options for lung cancer", "cancer", "high")
    ]
...
if __name__ == "__main__":
    main()ADP Version 1.0</strong> demonstrates:</p>
            <ul>
